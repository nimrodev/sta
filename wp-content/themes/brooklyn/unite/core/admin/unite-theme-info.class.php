                            ...
                            <table class="form-table ut-compare-table">
                                ...
                                <tbody>
                                    ...
                                    <tr valign="top">
                                        ...
                                        <th scope="row" class="ut-config-title-column"><?php esc_html_e( 'PHP Version:', 'unite-admin' ); ?></th>
                                        
                                        <td class="ut-config-value-column"><?php echo phpversion(); ?></td>
                                        <td class="ut-config-value-column">5.2.4</td>
                                        
                                        <td class="ut-config-info-column"></td>
                                        <td class="ut-config-info-column"></td>
