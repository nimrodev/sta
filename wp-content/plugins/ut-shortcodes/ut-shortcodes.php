...
define('UT_SHORTCODES_VERSION', '4.1');
...
//require_once( UT_SHORTCODES_DIR . '/shortcodes/blog.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/call-to-action.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/client-group.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/count-up.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/custom-shortcode.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/fancy-image.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/header.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/service-box.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/single-quote.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/parallax-quote.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/probar.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/quote-rotator.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/service-column.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/service-column-vertical.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/service-icon-box.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/title-divider.php' );
require_once( UT_SHORTCODES_DIR . '/shortcodes/word-rotator.php' );
...
require_once( UT_SHORTCODES_DIR . '/shortcodes/button.php' );
...
if( defined( 'WPB_VC_VERSION' ) ) {
    ...
    require_once( UT_SHORTCODES_DIR . '/shortcodes/animated-image.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/btn.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/social-share-bar.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/image-gallery.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/gallery-slider.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/media-slider.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/portfolio-details.php' );    
    require_once( UT_SHORTCODES_DIR . '/shortcodes/fancy-list.php' );
    require_once( UT_SHORTCODES_DIR . '/shortcodes/team-member.php' );
    //require_once( UT_SHORTCODES_DIR . '/shortcodes/split-section.php' );    
...
function ut_shortcodes_enqueuescripts() {
    ...
    if( !is_admin() ) {
        ...
        wp_enqueue_script(
            'ut-inviewport',
            UT_SHORTCODES_URL . 'js/jquery.isInViewport' . $min . '.js', 
            array('jquery'), 
            '1.0',
            true
        );
...
function ut_shortcodes_enqueuestyles() {
    ...
    if( !is_admin() ) {
        ...
        /* visual composer css */
		$ut_vc_shortcodes = file_exists( get_stylesheet_directory() . '/css/ut.vc.shortcodes' . $min . '.css' ) ? get_stylesheet_directory_uri() . '/css/ut.vc.shortcodes' . $min . '.css' : UT_SHORTCODES_URL . 'css/ut.vc.shortcodes' . $min . '.css';
		wp_enqueue_style( 
            'ut-vc-shortcodes', 
            $ut_vc_shortcodes,
