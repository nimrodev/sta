        ...
        function ut_create_shortcode( $atts, $content = NULL ) {
            ...
            $css = '<style type="text/css" scoped>';
                ...
                if( $font_size ) {
                    ...
                    $css .= '#' . $id . '.ut-word-rotator { font-size: ' . $font_size . '; }';
                    
                }    
                
                if( $font_color ) {
                    
                    $css .= '#' . $id . '.ut-word-rotator { color: ' . $font_color . ' !important; }';
                    
                }
                
                if( $text_align ) {
                    
                    $css .= '#' . $id . '.ut-word-rotator { text-align: ' . $text_align . '; }';
                    
                }
                
                if( $display ) {
                    
                    $css .= '#' . $id . '.ut-word-rotator { display: ' . $display . '; }';
            ...
            $output .= '<span id="' . $id . '" class="' . implode( ' ', $classes ) . ' ut-word-rotator">' . $words[0] . '</span>';
