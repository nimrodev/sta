            ...
            if( function_exists( 'vc_map' ) ) {
                ...
                vc_map(
                    array(
                        ...
                        'base'            => $this->shortcode,
                        'icon'            => UT_SHORTCODES_URL . '/admin/img/vc_icons/blog.png',
                        ...
                        'params'          => array(
                            array(
                                ...
                                'description' => esc_html__( 'Enter desired amount of posts to display.', 'ut_shortcodes' ),
