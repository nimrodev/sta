...
if ( class_exists( 'WPBakeryShortCodesContainer' ) ) {
    ...
    class WPBakeryShortCode_ut_split_section extends WPBakeryShortCode {
        ...
        public function getLayoutsControl() {
                ...
                $controls_layout.= '<br/><a class="vc_control-set-column set_columns custom_columns" data-cells="custom" data-cells-mask="custom" title="' . __('Custom layout', 'ut_shortcodes') . '">' . __('Custom', 'ut_shortcodes') . '</a> ';
