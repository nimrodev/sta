			...
			foreach ( $field_data as $k => $v ) {
                ...
                if( $v['type'] == 'showcase_info' ) {
					...
					$html .= '<tr valign="top">';
                        ...
                        $html .= '<p class="description">' . __('Default: 800x800' , 'ut_portfolio_lang') . '</p></td>';                        
					...
					$html .= '<tr valign="top">';
                        ...
                        $html .= '<div class="ut-display-size">';    
                            ...
                            $html .= '<div>';
                                ...
                                $html .= '<p class="description">' . __('Default: 200' , 'ut_portfolio_lang') . '</p>';
                            $html .= '</div>';
                    ...
                    /* text color */
                    $html .= '<tr valign="top">';
                        $html .= '<th scope="row">' . __('Category Color' , 'ut_portfolio_lang') . '</th>';
